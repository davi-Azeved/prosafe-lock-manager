...
CREATE TABLE `tbblock` (
  ...
  `data_block` timestamp NOT NULL DEFAULT current_timestamp(),
  ...
  KEY `usuario` (`usuario`),
  KEY `nomemaq` (`nomemaq`),
  CONSTRAINT `tbblock_ibfk_1` FOREIGN KEY (`usuario`) REFERENCES `tbusuarios` (`email`),
  CONSTRAINT `tbblock_ibfk_2` FOREIGN KEY (`nomemaq`) REFERENCES `tbmaquinas` (`nomemaq`)
